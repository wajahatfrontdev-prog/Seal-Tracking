...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`w-64 h-screen border-r fixed left-0 top-0 z-40 transition-all duration-300 flex flex-col ${
        isLight
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-2" style={{ scrollbarWidth: 'thin', scrollbarColor: '#4b5563 transparent' }}>
          <nav className="space-y-2">
            {navigation.map((item) => {
              const Icon = item.icon;
              const isActive = pathname === item.href;
          ...
          <div className="card p-3">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className={`text-xs truncate ${isLight ? 'text-gray-600' : 'text-gray-400'}`}>
